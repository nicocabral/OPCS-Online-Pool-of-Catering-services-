...
<body onload="loadreservation_new();resNotif();notification();">
<!-- header -->
        <?php include('header.php');?>
<div class="wrapper">
	<div class="container" style="height:auto;">
	<?php include('vrModal.php');
include('addNewreservation.php');
include('addNewreservation_rph.php');	?>
	<br>
	...
	<span class="pull-right wow slideRight">
		...
		<div class="row">
			<div class="col-lg-4">
				<label class="wow fadeInDown"><span class="text-muted">Home <i class="fa fa-arrow-right"></i> </span><i class="glyphicon glyphicon-list-alt"></i> Reservations listing
				</label>
			</div>
			<div class="col-lg-8">
			<div class="col-md-5">
			...
			<div class="col-md-3">
			<span class="pull-right wow fadeInDown" style="margin-top:5px;">
				<i class="fa fa-sort-alpha-asc" style="color:#228B22;margin-top:5px;"></i> Sort by</span>
			</div>
			<div class="col-md-4" >
			<div class="has-error col-sm-12">
					<select class="wow fadeInDown form-control" id="resfilter" onchange="showfilter(this.value);" >
						<option value="rpp">Rate per package</option>
						<option value="rph">Rate per head</option>
			</select>
			</div>
			</div>
		...
		<div class="row" style="margin-top:5px;">
			...
			<div>
			<div class="col-lg-12">
			<div class="table-responsive" id="reservationData">		
