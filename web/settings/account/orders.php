...
<body onload="notification();orderNotif();">
<!-- header -->
        <?php include('header.php');?>
<div class="wrapper">
	<div class="container" style="height:auto;">
	<?php include('voModal.php');	?>
	<br>
...
<span class="pull-right wow slideRight">
		...
		<div class="row">
			<div class="col-lg-4">
				<label class="wow fadeInDown"><span class="text-muted">Home <i class="fa fa-arrow-right"></i> </span><i class="glyphicon glyphicon-list-alt"></i> Orders listing
				</label>
			</div>
			<div class="col-lg-8">
			<div class="col-md-5">
			...
			<span class="pull-right wow fadeInDown" style="margin-top:5px;">
				<i class="fa fa-filter" style="color:#228B22;margin-top:5px;"></i> Filter by</span>
			</div>
			<div class="col-md-4" >
			<div class="has-error col-sm-12">
					<select class="wow fadeInDown form-control" id="resfilter" onchange="filterOrder(this.value);">
