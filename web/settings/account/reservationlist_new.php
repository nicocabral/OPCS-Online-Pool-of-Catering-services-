...
<table id="datatable-fixed-col" width="100%;" class="table table-striped table-bordered" style="box-shadow: 3px 2px 2px #000;cursor:pointer;" >
                               ...
                               <tbody id="reservation_res" class="wow fadeInDown">
								...
								$query = 'SELECT tbl_reservation.*,tbl_ocasioncat.* FROM tbl_reservation LEFT JOIN tbl_ocasioncat ON tbl_ocasioncat.oid = tbl_reservation.ocasion_id WHERE tbl_reservation.res_status = "New" AND tbl_reservation.catererid ='.$_SESSION['id'].'';
