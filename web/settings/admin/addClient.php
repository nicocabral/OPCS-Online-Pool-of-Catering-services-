...
<script src="clientFunction.js"></script>
<style>
.loader 
{
 position: fixed;
...
<div class="processLoader"></div>
    <body onload="displayRecords(); notifRequest(); notifContents();" style="font-family:'Cosmic',cursive;">
		...
		<?php }else {
			...
			<?php }
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="includes/logout_process?logout= echo $_SESSION['adminID'];"><i class="ti-power-off text-danger m-r-10"></i> Logout</a></li>
                                </ul>
                            </li>
                        </ul>
						 <div class="menu-item">
                        ...
                        <ul class="navigation-menu">
                            <li class="has-submenu active">
							 ...
							 <li class="has-submenu">
                                <a href="#" class="submenu-toggle"><i class="fa fa-cogs"></i>Module</a>
                                <ul class="submenu">
                ...
                <div class="row">
                    <div class="has-success col-lg-12">
                        <div class="card-box " style="box-shadow: 1px 1px 1px 1px #888888;">
                            <div class="row">
							<div class="col-sm-4">
		<button class="btn btn-success waves-effect waves-light" style="border-radius:0;" onclick="showModal();">
		<i class="fa fa-plus"></i> Add Client - (Caterer)</button>
							</div>
							<div class="col-sm-4">
							<div class="col-sm-6">
							<h4 class="pull-right"><i class="fa fa-filter" style="color:#81c868;"></i> Sort by:</h4>
							</div>
							<div class="has-success col-sm-6">
							<select class="form-control pull-left" onchange="deactRequest(this.value);" style="cursor:pointer;">
							...
							<div class="col-sm-4">
							<strong><p class="pull-right" style="font-size:13px;"><em><i class=" fa fa-hand-pointer-o"></i> Double click each row to select action</em></p></strong>
							</div> 
                            </div>
